...
<body>
    ...
    <div class="container mt-2">
        <div class="row">
            ...
            @endif
            <form action="{{ route('member_refuns.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="form-group my-3">
                            ...
                            <input type="number" name="current_points" class="form-control" placeholder="Current_point">
